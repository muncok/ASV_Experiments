...
data_dir=kaldi_voxc/data-dvector
train_dir=$data_dir/train
test_dir=$data_dir/test
trials=kaldi_voxc/data/voxceleb1_trials/voxceleb1_trials_sv
scores_dir=$1/plda_scores

# place dvecoter at data-dvector/~
./numpy2ark.py -input $1/voxc_train_dvectors.pkl -output $train_dir/data/
./numpy2ark.py -input $1/voxc_test_dvectors.pkl -output $test_dir/data/

# compute dvector mean for following global mean subtraction
ivector-mean ark:$train_dir/data/feats.ark $train_dir/mean.vec || exit 1;

# compute plda model
run.pl $train_dir/log/plda.log \
    ivector-compute-plda ark:$train_dir/spk2utt \
    "ark:ivector-subtract-global-mean ark:${train_dir}/data/feats.ark ark:- | ivector-normalize-length ark:- ark:- |" \
...
run.pl $scores_dir/log/plda_scoring.log \
  ivector-plda-scoring --normalize-length=true \
    ...
    "ark:ivector-subtract-global-mean ${train_dir}/mean.vec ark:${test_dir}/data/feats.ark ark:- | ivector-normalize-length ark:- ark:- |" \
    "ark:ivector-subtract-global-mean ${train_dir}/mean.vec ark:${test_dir}/data/feats.ark ark:- | ivector-normalize-length ark:- ark:- |" \
