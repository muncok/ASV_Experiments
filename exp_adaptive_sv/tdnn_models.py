...
class tdnn_xvector_self_att_v1(tdnn_xvector_self_att_v0):
    """
    ...
    def __init__(self, config, base_width, n_labels):
        ...
        self.r = 40
        self.h_dim = 300
        self.w_s1 = nn.Parameter(torch.randn(self.h_dim, self.stat_dim))
        self.w_s2 = nn.Parameter(torch.randn(self.r, self.h_dim))
