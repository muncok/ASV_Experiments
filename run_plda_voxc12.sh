...
./numpy2ark.py -input $1/voxc_train_dvectors.pkl -output $train_dir || exit 1;
./numpy2ark.py -input $1/voxc_test_dvectors.pkl -output $test_dir || exit 1;
