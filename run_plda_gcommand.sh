...
trials=kaldi_gcommand/data/gcommand_trial
...
mkdir -p $train_dir
mkdir -p $test_dir
cp dataset/gcommand/spk2utt_equal30 $train_dir/spk2utt

./numpy2ark.py -input $1/gcommand_train_dvectors.pkl -output $train_dir
./numpy2ark.py -input $1/gcommand_test_dvectors.pkl -output $test_dir
